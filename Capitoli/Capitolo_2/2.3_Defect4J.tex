...
oggi lo standard \textit{de facto} per la valutazione delle tecniche di \textit{Automated Program Repair}
in ambito Java.
...
Apache Commons Math e Jackson). Ogni difetto non è artificiale né iniettato a tavolino, ma corrisponde
a un problema effettivamente verificatosi e successivamente corretto dagli sviluppatori del progetto.
Questa caratteristica è ciò che rende il benchmark credibile: misurare un sistema APR su bug sintetici
direbbe poco sulla sua reale utilità, mentre Defects4J riproduce la complessità del software industriale.
...
Avere chiaro fin da ora che cosa sia Defects4J, come siano strutturati i suoi difetti e quale
sottoinsieme venga impiegato è il presupposto necessario per seguire i capitoli successivi, nei quali
i singoli bug (a partire dal già citato \texttt{Closure-2}) verranno richiamati come esempi concreti
