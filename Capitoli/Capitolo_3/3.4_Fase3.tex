...
metodo difettoso, la \texttt{RepairSpec} e gli \texttt{Ingredients}; tuttavia tali informazioni sono localizzate
attorno all'epicentro del difetto, e due categorie di anomalie rendono insufficiente questo perimetro:
